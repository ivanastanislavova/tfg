...
// import NotificacionProximidad from './NotificacionProximidad'; // ELIMINADO para evitar duplicados
...
const Main = ({ route }) => {
    return (
        // Eliminado NotificacionProximidad de aquí, solo debe estar en App.js
        <Tab.Navigator
            screenOptions={{
